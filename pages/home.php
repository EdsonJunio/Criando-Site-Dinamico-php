<section class="banner-principal">
    ...
    <section class="descricao-autor">
      ...
      <div class="w50 left">
        <!--pegar imagens depois-->
        <img class="right" src="<?php echo INCLUDE_PATH; ?>imagens/download.jpg">
        </div><!--w50-->
        <div class="clear"></div>
        </div><!--center-->   
        ...
        <div class="center">
          ...
          <div class="w33 left box-especialidades">
             ...
             <P>centuries, but also the leap into electronic
                 ...
                 was popularised in the 1960s centuries, but also
                  the leap into electronic </P>
            ...
            <div class="w33 left box-especialidades">
             ...
             <P>centuries, but also the leap into electronic
                 typesetting, remaining essentially unchanged. 
                 was popularised in the 1960scenturies, but also 
               the leap into electronic </P>
           </div><!--box-especialidade-->
            <div class="w33 left box-especialidades">
           ...
           <div class="center">
             <div class="w50 left depoimentos-container">
              ...
              <div class="depoimento-single">
                ...
                <p>centuries, but also the leap into electronic
                 typesetting, remaining essentially unchanged. 
                 was popularised in the 1960s with the releasea 
               ...
               <div class="w50 left servicos-container">
                 ...
                 <div class="servicos"> 
                  <ul>
                     <li>centuries, but also the leap into electronic
                 typesetting, remaining essentially unchanged. 
                 was popularised in the 1960s with the release 
                 a type specimen book. It has survived not only 
                 five centuries, but</li>
                     <li>centuries, but also the leap into electronic
                 typesetting, remaining essentially unchanged. 
                 was popularised in the 1960s with the release 
                 a type specimen book. It has survived not only 
